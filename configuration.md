...
| allow-untested-ig-version | Optional | Do not warn the user if they are using an untested version of the IG app. The 'parameter' eliminates the need to press ENTER every time the bot is run. | `false` |
